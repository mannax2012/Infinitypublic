...
private:
	...
	int performTip(CreatureObject* player, CreatureObject* targetPlayer,
		...
		if (amount > 999999)
			error("CreditTracking: " + player->getFirstName() + " tipped " + String::valueOf(amount) + " credits to " + targetPlayer->getFirstName());
	...
	int performBankTip(CreatureObject* player, CreatureObject* targetPlayer,
		...
		if (amount > 999999)
			error("CreditTracking: " + player->getFirstName() + " bank tipped " + String::valueOf(amount) + " credits to " + targetPlayer->getFirstName());

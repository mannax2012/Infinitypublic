...
ZoneImplementation::ZoneImplementation(ZoneProcessServer* serv, const String& name) {
	...
	/*
	if (name == "corellia" || name == "dantooine" ||  name == "naboo" || name == "tatooine")
		numThreads = 4;

	if (name == "dathomir" || name == "endor" || name == "lok" || name == "rori" || name == "talus" || name == "yavin4")
		numThreads = 2;	

	if (name == "dungeon1" || name == "dungeon2")
		numThreads = 2;

	if (name == "kashyyyk_hunting")
		numThreads = 1;
	...
	*/
	...
	info("Zone " + name + " using " + String::valueOf(numThreads) + " threads.",true);

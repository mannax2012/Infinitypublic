...
object_tangible_medicine_crafted_medpack_poison_mind_b = object_tangible_medicine_crafted_shared_medpack_poison_mind_b:new {
	gameObjectType = 8240,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_poison_mind_b, "object/tangible/medicine/crafted/medpack_poison_mind_b.iff")

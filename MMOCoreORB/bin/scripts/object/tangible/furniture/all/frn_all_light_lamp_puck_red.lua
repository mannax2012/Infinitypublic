...
object_tangible_furniture_all_frn_all_light_lamp_puck_red = object_tangible_furniture_all_shared_frn_all_light_lamp_puck_red:new {
...
ObjectTemplates:addTemplate(object_tangible_furniture_all_frn_all_light_lamp_puck_red, "object/tangible/furniture/all/frn_all_light_lamp_puck_red.iff")

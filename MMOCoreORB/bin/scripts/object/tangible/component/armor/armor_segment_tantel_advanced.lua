...
object_tangible_component_armor_armor_segment_tantel_advanced = object_tangible_component_armor_shared_armor_segment_tantel_advanced:new {
	...
	experimentalMin = {0, 0, 1000, 1, 100, 13, 13, 16, 1, 2, 1, 100},
	experimentalMax = {0, 0, 1000, 25, 1000, 1, 1, 1, 1, 2, 35, 1000},
	experimentalPrecision = {0, 0, 0, 12, 0, 0, 0, 0, 0, 0, 12, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_tantel_advanced, "object/tangible/component/armor/armor_segment_tantel_advanced.iff")

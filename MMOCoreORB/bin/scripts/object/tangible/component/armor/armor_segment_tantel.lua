...
object_tangible_component_armor_armor_segment_tantel = object_tangible_component_armor_shared_armor_segment_tantel:new {
	...
	experimentalMax = {0, 0, 1000, 10, 1000, 1, 1, 1, 1, 2, 15, 1000},
	experimentalPrecision = {0, 0, 0, 12, 0, 0, 0, 0, 0, 0, 12, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_tantel, "object/tangible/component/armor/armor_segment_tantel.iff")

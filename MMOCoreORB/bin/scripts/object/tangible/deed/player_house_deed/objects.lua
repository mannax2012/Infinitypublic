...
--commando house dark deed **@@ crashes client
--object_tangible_deed_player_house_deed_shared_commando_house_dark_deed = SharedTangibleObjectTemplate:new {
--	clientTemplateFileName = "object/tangible/deed/player_house_deed/shared_commando_house_dark_deed.iff"
--}
--ObjectTemplates:addClientTemplate(object_tangible_deed_player_house_deed_shared_commando_house_dark_deed, "object/tangible/deed/player_house_deed/shared_commando_house_dark_deed.iff")

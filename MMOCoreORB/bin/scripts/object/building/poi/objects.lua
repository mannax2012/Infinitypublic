...
object_building_poi_shared_tatooine_jawa_krayt_large1 = SharedBuildingObjectTemplate:new {
	clientTemplateFileName = "object/building/poi/shared_tatooine_jawa_krayt_large1.iff"
}

ObjectTemplates:addClientTemplate(object_building_poi_shared_tatooine_jawa_krayt_large1, "object/building/poi/shared_tatooine_jawa_krayt_large1.iff")

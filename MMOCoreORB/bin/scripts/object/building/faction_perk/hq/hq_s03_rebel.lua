...
object_building_faction_perk_hq_hq_s03_rebel = object_building_faction_perk_hq_shared_hq_s03_rebel:new {
	...
	childObjects = {
		...
		{ templateFile = "object/installation/faction_perk/turret/tower_lg.iff", x = -18.2, z = 0, y = -12, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1 },
		{ templateFile = "object/installation/faction_perk/turret/tower_lg.iff", x = 18.2, z = 0, y = -12, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1 },
		...
		{ templateFile = "object/tangible/terminal/terminal_hq_rebel.iff", x = .75, z = .25, y = 1.75, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 2, containmentType = -1 },

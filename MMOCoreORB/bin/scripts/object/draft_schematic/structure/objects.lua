...
object_draft_schematic_structure_shared_naboo_house_player_large_dark = SharedDraftSchematicObjectTemplate:new {
	clientTemplateFileName = "object/draft_schematic/structure/shared_naboo_house_player_large_dark.iff"
}

ObjectTemplates:addClientTemplate(object_draft_schematic_structure_shared_naboo_house_player_large_dark, "object/draft_schematic/structure/shared_naboo_house_player_large_dark.iff")

...
object_draft_schematic_structure_naboo_house_player_large_dark = object_draft_schematic_structure_shared_naboo_house_player_large_dark:new {
	...
	targetTemplate = "object/tangible/deed/naboo/player_house_deed/naboo_house_large_deed_dark.iff",

	additionalTemplates = {}
}
ObjectTemplates:addTemplate(object_draft_schematic_structure_naboo_house_player_large_dark, "object/draft_schematic/structure/naboo_house_player_large_dark.iff")

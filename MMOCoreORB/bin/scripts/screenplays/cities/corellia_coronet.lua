CorelliaCoronetScreenPlay = CityScreenPlay:new {
	...
	gcwMobs = {
		...
		{"stormtrooper_squad_leader", "rebel_surface_marshal", -502.1, 28, -4701.1, 185.005, 0, "", ""},
...
function CorelliaCoronetScreenPlay:spawnMobiles()
	...
	-- Smashball
	spawnMobile(self.planet, "smashball_bully",300,-205.027,28.3091,-3998.32,80.3182,0)
	spawnMobile(self.planet, "smashball_bully",300,-208.5,29.2,-3999.9,191.197,0)
	spawnMobile(self.planet, "smashball_bully",300,-205.027,29.2182,-4001.32,192.016,0)
	spawnMobile(self.planet, "smashball_bully",300,-201.8,28.6,-4000.2,-122,0)

SennexCaveScreenPlay = ScreenPlay:new {
	...
	lootGroups = {
		...
		{
			groups = {
				{group = "art_illum3", chance = 10000000}
			},
			lootChance = 2800000
		} 				
	},
...
function SennexCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "cave_beetle", 90, 94.9631, -46.6007, -134.941, 0, 5995575)
	spawnMobile("tatooine", "cave_beetle", 90, 88.5285, -46.5252, -146.986, 0, 5995575)
	-- removed for mandalorian quest
	--spawnMobile("tatooine", "large_cave_beetle", 120, 82.3354, -46.5893, -144.681, 0, 5995575)
	spawnMobile("tatooine", "cave_beetle", 90, 77.9578, -46.3635, -137.141, 0, 5995575)

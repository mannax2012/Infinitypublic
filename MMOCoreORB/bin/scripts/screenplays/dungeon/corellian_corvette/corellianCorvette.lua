...
function CorellianCorvette:start()
	if (isZoneEnabled("dungeon1")) then
		self:initialize()
		self:spawnTicketLocations()
	end
end
function CorellianCorvette:spawnTicketLocations()
	--@@ imperial Tickets

	-- Destroy Mission: Lt. Velso: Emperor's retreat, Naboo (2405  -3967)
	-- 1st - Tavern, Anchorhead, Tatooine (134, -5349) - Search Container, downstairs. - ##fixed##
	spawnSceneObject("tatooine", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_destroy_02.iff", -1.97, -3.97, -6.91, 1213349, math.rad(0))
	-- 2nd - Janta Stronghold, Dantooine (7197, -4090) - Search Drum @ bottom of cave.
	spawnSceneObject("dantooine", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_destroy_03.iff", -10.41, -69.02, -90.59, 529331, math.rad(10))
	-- 3rd - Erran Sif, Talus (2143, -5649) - Search Table. shared_corvette_search_imperial_destroy_01.iff
	spawnSceneObject(    "talus", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_destroy_01.iff", -3.67, -6.77, -18.13, 9815430, math.rad(0))

	-- Assassination mission: Lt Sabol: Tatooine, Bestine (-1291 -3539)
	-- 1st - Afarah Cave, Corellia (-2557 3005) - Search Container, bottom of Cave. - ##fixed##
	spawnSceneObject("corellia", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_assassination_02.iff", -21.68, -80.47, -154.51, 6035629, math.rad(5))
	-- 2nd - Abandoned Rebel Base, Dantooine (-6676 5557) - Search Container in building.
	spawnSceneObject("dantooine", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_assassination_03.iff", 3.03, 0.13, -0.45, 3035995, math.rad(-126))
	-- 3rd - Crashed Space Craft, Dathomir (5696 1952) - Search Container.
	spawnSceneObject( "dathomir", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_assassination_01.iff", 5694.33, 122.00, 1935.47, 0, math.rad(-134))

	-- Rescue mission: Colonel Darkstone: Tatooine, Imperial Oasis (-5321 2702)
	-- 1st - Droid Engineer Cave, Lok - Search Container bottom of Cave.
	spawnSceneObject(     "lok", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_rescue_03.iff", 50.25, -65.69, -83.30, 568983, math.rad(35))
	-- 2nd - Rogue Corsec Base, Corellia (5200 1600) - Search Container in Small building, downstairs. - ##fixed##
	spawnSceneObject("corellia", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_rescue_02.iff", 5216.6, 5, 1505.6, 0, math.rad(0))
	-- 3rd - Woolamander Palace, Yavin - Search Container near Harrowers.
	spawnSceneObject(   "yavin4", "object/tangible/dungeon/corellian_corvette/corvette_search_imperial_rescue_01.iff", -75.51, 2.02, 25.74, 3705359, math.rad(30))

	--@@ Neutral Tickets: (Jabba)

	-- Destroy Mission: Bruce McBrain: Jabba's Palace, Tatooine Entrance area (-580 6220)
	-- 1st - Maulers Stronghold, Naboo - Search Container
	spawnSceneObject(    "naboo", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_destroy_01.iff", -6.94, 0.70, 1.90, 1696447, math.rad(0))
	-- 2nd - Rogue Corsec Base, Corellia - Search Container
	spawnSceneObject( "corellia", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_destroy_02.iff", 5218, 5, 1506, 0, math.rad(-180))
	-- 3rd - Nightsister Slave Labor Camp, Dathomir - Search Container in side cave (Go left, then small room to right)
	spawnSceneObject( "dathomir", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_destroy_03.iff", 51.93, -67.77, -48.01, 8575576, math.rad(34))

	-- Assassination mission: Bronell: Jabba's Palace, Tatooine 2nd Floor by Ephont Mon (-5914 -6232)
	-- 1st - Binayre Pirates POI, Talus (POI)
	spawnSceneObject(    "talus", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_assassination_01.iff", 12.98, -13.76, 14.30, 6075879, math.rad(90))
	-- 2nd - Pirate Bunker, Naboo (-1507 -1729)
	spawnSceneObject(    "naboo", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_assassination_02.iff", 9.48, -12.00, 36.22, 5535567, math.rad(-154))
	-- 3rd - Canyon Corsairs POI, Lok
	spawnSceneObject(      "lok", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_assassination_03.iff", -3893.03, 12.00, -3801.24, 0, math.rad(-50))

	-- Rescue mission: Yondalla: Wayfar, Tatooine Inside cantina (-5150 -6588)
	-- 1st - Kahmurra POI, Talus - Search Container, bottom room
	spawnSceneObject(    "talus", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_rescue_01.iff", -8.18, -13.75, -0.25, 4795365, math.rad(141))
	-- 2nd - Lord Nyax POI, Corellia - Search Bookcase, bottom room - ##fixed##
	spawnSceneObject( "corellia", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_rescue_02.iff", -6.03, -13.76, 15.06, 6036002, math.rad(-180))
	-- 3rd - Korga Cave POI, Endor - Search Rusty Container, take right
	spawnSceneObject(    "endor", "object/tangible/dungeon/corellian_corvette/corvette_search_neutral_rescue_03.iff", 87.88, -46.11, -149.07, 733370, math.rad(0))

	--@@ Rebel Tickets:

	-- Destroy Mission: Master Sergeant Crowley: Corellia, Kor Vella (-3404 3092)
	-- 1st - Imperial Base, Lok (-1891 -3032) - Search
	spawnSceneObject(      "lok", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_destroy_01.iff", -1891.28, 12.00, -3033.79, 0, math.rad(0))
	-- 2nd - Imperial Prison Camp, Dathomir - Search Desk in Prisoner room
	spawnSceneObject( "dathomir", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_destroy_03.iff", 2.38, 0.13, 0.04, 5335775, math.rad(70))
	-- 3rd - Corbal Cave POI, Rori - Search Bookcase, second level - ##fixed##
	spawnSceneObject(     "rori", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_destroy_02.iff", 5.99, -13.75, 10.12, 6055635, math.rad(-180))

	-- Assassination mission: Pashna Starkiller: Corellia, Bela Vistal (6772 -5697)
	-- 1st - Geonosian Cave, Yavin4 - Search Desk in Second Room
	-- NOTE: The desk was moved out of Poggle's room to the first room
	spawnSceneObject(   "yavin4", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_assassination_03.iff", -56.40, -18.00, -53.10, 1627785, math.rad(-104))
	-- 2nd - Fort Tusken, Tatooine - Search Crate, bottom of cave
	spawnSceneObject( "tatooine", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_assassination_01.iff", 11.63, 22.72, -20.67, 1189183, math.rad(-14.89))
	-- 3rd - Mokk Village, Dantooine (-7065 -3326) - Search Drum - ##fixed##
	spawnSceneObject("dantooine", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_assassination_02.iff", -7064.63, 1.81, -3326.07, 0, math.rad(-26))

	-- Rescue mission: Adar Tallon: Corellia, Tyrena (-5448 -2674)
	-- 1st - Warren POI, Dantooine (-526 -3870) - Search Table, first big room, downstairs.
	spawnSceneObject("dantooine", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_rescue_01.iff", 11.34, -28.00, -29.77, 8575689, math.rad(-90))
	-- 2nd - Crash Site, Lok - (3658 2185) - Search Crate in small room
	spawnSceneObject(      "lok", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_rescue_03.iff", 2.38, 0.13, 3.65, 568758, math.rad(90))
	-- 3rd - Imperial Prison POI, Dathomir (-6352 749) - Search Crate in prisoner room
	spawnSceneObject( "dathomir", "object/tangible/dungeon/corellian_corvette/corvette_search_rebel_rescue_02.iff", 2.36, 0.13, -0.05, 5335810, math.rad(-180))

    
	-- random decorations
	spawnSceneObject("corellia","object/static/structure/tatooine/jawa/tent_jawa_01_small.iff",5217.6,5,1504,0,math.rad(-180))
end
		...
		if (pCell ~= nil) then
			for j = 1, SceneObject(pCell):getContainerObjectsSize(), 1 do
				...
				if pObject ~= nil and SceneObject(pObject):isPlayerCreature() then
					...
					big_game_hunter:contentXP(pObject, 50000)

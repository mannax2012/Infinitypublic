...
function TalusStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "imperial_army_captain", 360, -2.2, 0.7, -2.0, 90, 9505499)
	-- room 9505500 is in mandalorian quest
	...
	spawnMobile("talus", "lost_aqualish_marshal", 360, -99.5, 72.4, 2616.3, 140, 0)
